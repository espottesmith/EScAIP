...
class EfficientGraphAttentionChargeSpin(BaseGraphNeuralNetworkLayerChargeSpin):
    """
    Efficient Graph Attention module, including charges and/or spins.
    """
    ...
    def forward(
        self,
        data: GraphAttentionDataChargeSpin,
        node_features: torch.Tensor,
        edge_features: torch.Tensor
    ):
        # Get edge features
...
class EfficientGraphAttentionBlockChargeSpin(nn.Module):
    """
    Efficient Graph Attention Block module, including charges and/or spins.
    Modified from https://github.com/facebookresearch/xformers/blob/main/xformers/factory/block_factory.py#L96
    """
    ...
    def __init__(
        ...
        # Graph attention
        self.graph_attention = EfficientGraphAttentionChargeSpin(
            global_cfg=global_cfg,
            molecular_graph_cfg=molecular_graph_cfg,
            gnn_cfg=gnn_cfg,
            reg_cfg=reg_cfg,
