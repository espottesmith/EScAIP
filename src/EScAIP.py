...
@registry.register_model("EScAIP-ChargeS")
class EfficientlyScaledAttentionInteratomicPotentialChargeSpin(nn.Module, GraphModelMixin):
    """ """
...
class EScAIPChargeSExportable(nn.Module):
    def __init__(
        self,
        global_cfg: GlobalConfigs,
        molecular_graph_cfg: MolecularGraphConfigs,
